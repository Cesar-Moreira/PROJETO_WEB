...
$dados = [
    ...
    'pais_id'       => $cidadeAtual['pais_id'],
    'populacao'     => $cidadeAtual['populacao'],
    'area_km2'      => $cidadeAtual['area_km2'],
    'clima'         => $cidadeAtual['clima'],
    'governante_id' => $cidadeAtual['governante_id'],
    'data_fundacao' => $cidadeAtual['data_fundacao'],
];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($erros)) {
        try {
            $stmt = $pdo->prepare(
                'UPDATE cidades SET
                    nome = :nome, pais_id = :pais_id, populacao = :populacao,
                    area_km2 = :area_km2, clima = :clima, governante_id = :governante_id,
            ...
            $erros[] = 'Ocorreu um erro ao atualizar a cidade. Tente novamente.';
        }
    }
}

$tituloPagina = 'Editar Cidade - CRUD Mundo';
...
<div class="conteudo">
    <div class="conteudo-principal">
        <div class="pagina-titulo">
            <h1><i class="fa-solid fa-pen"></i> Editar Cidade</h1>
        </div>
        ...
        <div class="form-container">
            <form method="POST" novalidate>
                ...
                <div class="form-grupo">
                    ...
                    <input type="date" id="data_fundacao" name="data_fundacao" value="<?= htmlspecialchars((string) $dados['data_fundacao']) ?>">
                </div>
